"""
Minimal filesystem MCP server: read_file, write_file, list_dir (workspace-scoped).

Root directory: OLLAMACODE_FS_ROOT env var, or current working directory.
Run: python examples/fs_mcp.py  (stdio)
Config: {"type": "stdio", "command": "python", "args": ["examples/fs_mcp.py"]}
"""
