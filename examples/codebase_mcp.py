"""
Optional codebase search MCP server: search_codebase (keyword search across workspace).

Root directory: OLLAMACODE_FS_ROOT env var, or current working directory.
Run: python examples/codebase_mcp.py  (stdio)
Config: {"type": "stdio", "command": "python", "args": ["examples/codebase_mcp.py"]}
Add to ollamacode.yaml alongside fs_mcp for @codebase-style context.
"""
